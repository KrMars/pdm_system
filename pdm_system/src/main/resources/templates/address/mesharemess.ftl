			...
			<div>
				<div class="sharecontent-left" style="height: 30px;">
					...
					<a href="javascript:void(0);" 
						...
						<img src="/images/${(du.director.imagePath)!'timg.jpg'}" class="img-circle" style="width:24px;height:24px"/>
					...
					共享给了:
						...
						>
							<img src="/images/${(du.user.imgPath)!'timg.jpg'}" class="img-circle" style="width:24px;height:24px"/> ${du.user.userName}
						</a>
				</div>
